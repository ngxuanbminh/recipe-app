...
const spoonacularCredentials = computed(() => {
  return {
    username: spoonacularStore.spoonacularUser?.username || '',
...
const connectUserToSpoonacular = () => {
...
<template>
  <div class="spoonacular-user-status">
    ...
    <div v-else class="mb-4">
      ...
      <p class="text-sm text-gray-600 mb-3">
        Connect your account to Spoonacular to save preferences, meal plans, and more across devices.
      </p>
      <button 
    ...
    <div v-if="connectionError" class="text-sm text-red-600 mt-2">
